...
const ModalShare = ({ visible, terminou, tamanho, shareFunction, closeFunction, codigo, finishFunction , copy}) => {
  return (
      ...
      <ModalContainer>
        <ModalBox>
          {!terminou ? (
            ...
            <Container>
              <MensagemCompartilhar>Use este código ao na aba de criação para copiar as perguntas</MensagemCompartilhar>
              <IconeSelecao>
